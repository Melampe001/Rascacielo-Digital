...
class ResumenAgent extends BaseAgent {
  constructor(config = {}) {
    super({
      ...
      description: 'resumen agent for documentation',
  ...
  async _generate(_context) {
    return [{ type: 'resumen', file: 'docs/resumen.md' }];
  }
}

module.exports = ResumenAgent;
