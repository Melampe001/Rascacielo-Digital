...
class ReemplazarAgent extends BaseAgent {
  constructor(config = {}) {
    super({
      ...
      description: 'reemplazar transformation agent',
  ...
  async _transform(_context) {
    return [{ type: 'reemplazar', status: 'completed' }];
  }
}

module.exports = ReemplazarAgent;
